...
<div class="row">
    ...
    <div class="card mb-4 col-md-8">
        ...
        <div class="card-body">
            ...
            <a class="btn btn-primary btn-sm" href="{{ route('books.edit', $book) }}"><i class="fa fa-edit"></i> تعديل</a>
            <form method="POST" action="{{ route('books.show', $book) }}" style="display:inline-block">
                @method('delete')
                @csrf
