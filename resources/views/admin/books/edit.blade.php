        ...
        <div class="card-body">
            <form action="{{ route('books.show', $book) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <select id="publisher" class="form-control" name="publisher">
                            ...
                            @foreach($publishers as $publisher)
                                <option value="{{ $publisher->id }}" {{ $book->publisher == $publisher ? 'selecte' : '' }}>{{ $publisher->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="number_of_pages" type="number" class="form-control @error('number_of_pages') is-invalid @enderror" name="number_of_pages" value="{{ $book->number_of_pages }}" required autocomplete="number_of_pages">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="number_of_copies" type="number" class="form-control @error('number_of_copies') is-invalid @enderror" name="number_of_copies" value="{{ $book->number_of_copies }}" required autocomplete="number_of_copies">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="price" type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $book->price }}" required autocomplete="price">
