...
<div class="row">
    <div class="col-md-12">
        <table id="authors-table" class="table table-stribed text-right" width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th>الاسم</th>
                    <th>الوصف</th>
                ...
                @foreach($authors as $author)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{ route('authors.show', $author) }}" style="display:inline-block">
                                @method('delete')
                                @csrf
